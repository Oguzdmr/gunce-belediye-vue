                    ...
                    <div class="team-grid official-members">
                      <div class="row">
                        <div class="col-md-12 col-sm-12">
                          <a href="#"
                            ><div class="team-box" style="height:200px;">
                              <div class="team-thumb"></div>
                              <div
                                class="team-txt"
                                style="height:200px; padding-top:90px;background:#77777787;color:white; "
                              >
                                <h5 style="color:white;">
                                  Tarihi yer bulunamadı.
                                </h5>
                              </div>
                            </div></a
                          >
