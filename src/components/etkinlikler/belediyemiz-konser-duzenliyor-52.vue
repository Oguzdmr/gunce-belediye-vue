<template>
  <div>
    <div class="wrapper">
      ...
      >
        <div class="container">
          <h2>Belediyemiz Konser D&#252;zenliyor.</h2>
          <ul>
            <li><a href="/">Anasayfa</a></li>
            <li>Belediyemiz Konser D&#252;zenliyor.</li>
          </ul>
        </div>
      </section>
            ...
            <div class="row">
              ...
              >
                <div class="event-details">
                  <div class="event-thumb gosterslayt">
                    <img
                  ...
                  <div class="event-counter">
                    <ul>
                      <li>
                        <h3 style=" margin:15px;padding:15px 0px; color:white;">
                  ...
                  <div class="event-content">
                    ...
                    <div class="event-date-share">
                      <div class="edate">
                        <strong>28</strong> Eyl <span class="year">2019</span>
                      </div>
                    </div>
                    <!--Date and Share End-->
                    <div class="etext">
                      <ul class="emeta">
                        ...
                        <li>
                          <strong><i class="fas fa-clock"></i> Saat:</strong>
                          14:00
                        </li>
                      </ul>
                      <p>
                        Belediyemizin d&#252;zenlediği konsere herkes
                        davetlidir. Mobil uygulamamızdan kayıt yaptırmayı
                        unutmayınız.
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    class="post-comments-form wf100"
                    style="margin-top:30px;"
                  >
                    <h3 class="stitle">Yorum Yap</h3>
                    <div class="row">
                      <ul>
