<template>
  <div>
    ...
    <div class="wrapper">
      ...
      >
        <div class="container">
          <h2>Bir Fidan Bir Hayat</h2>
          <ul>
            <li><a href="/">Anasayfa</a></li>
            <li>Bir Fidan Bir Hayat</li>
          </ul>
        </div>
      </section>
                ...
                <div class="event-details">
                  ...
                  <div class="event-content">
                    ...
                    <div class="event-date-share">
                      <div class="edate">
                        <strong>27</strong> Eyl <span class="year">2019</span>
                      </div>
                    </div>
                    <!--Date and Share End-->
                    <div class="etext">
                      ...
                      <p>
                        Belediyemizin başlattığı bir fidan bir hayat etkinliğine
