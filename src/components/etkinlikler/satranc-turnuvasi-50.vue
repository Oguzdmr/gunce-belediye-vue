<template>
  <div>
    ...
    <div class="wrapper">
      ...
      >
        <div class="container">
          <h2>Satran&#231; Turnuvası</h2>
          <ul>
            <li><a href="/">Anasayfa</a></li>
            <li>Satran&#231; Turnuvası</li>
          </ul>
        </div>
      </section>
                ...
                <div class="event-details">
                  ...
                  <div class="event-content">
                    ...
                    <div class="event-date-share">
                      <div class="edate">
                        <strong>26</strong> Eyl <span class="year">2019</span>
                      </div>
                    </div>
                    <!--Date and Share End-->
                    <div class="etext">
                      ...
                      <p>
                        Belediyemizin D&#252;zenlediği &#199;ocuklara
                        Y&#246;nenelik Satran&#231; Turnuvamıza Herkes
                        Davetlidir.
                      </p>
                    </div>
                  </div>
