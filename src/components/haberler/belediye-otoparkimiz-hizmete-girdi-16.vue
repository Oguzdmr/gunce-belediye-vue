<template>
  <div>
    ...
    <div class="wrapper">
      ...
      >
        <div class="container">
          <h2>Belediye Otoparkımız Hizmete Girdi !</h2>
          <ul>
            <li><a href="/">Anasayfa</a></li>
            <li>Belediye Otoparkımız Hizmete Girdi !</li>
          </ul>
        </div>
      </section>
                ...
                <div class="event-details">
                  ...
                  <div class="event-content" style="padding-left: 0px;">
                    <h6 style="margin-top: 20px; color: #777!important">
                      ...
                      ></i
                      ><strong>31</strong> Tem <span class="year">2019</span>
                    </h6>
                    <h3 style="padding:15px 0px; color:black;">
                      Belediye Otoparkımız Hizmete Girdi !
                    </h3>
