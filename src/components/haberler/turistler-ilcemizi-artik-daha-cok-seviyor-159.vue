<template>
  <div>
    <div class="wrapper">
      ...
      >
        <div class="container">
          <h2>Turistler il&#231;emizi artık daha &#231;ok seviyor.</h2>
          <ul>
            <li><a href="/">Anasayfa</a></li>
            <li>Turistler il&#231;emizi artık daha &#231;ok seviyor.</li>
          </ul>
        </div>
      </section>
                ...
                <div class="event-details">
                  ...
                  <div class="event-content" style="padding-left: 0px;">
                    ...
                    <h3 style="padding:15px 0px; color:black;">
                      Turistler il&#231;emizi artık daha &#231;ok seviyor.
                    </h3>
