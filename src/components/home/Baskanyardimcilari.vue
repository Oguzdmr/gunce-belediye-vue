              ...
              >
                <div class="team-grid official-members">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div>
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/baskanYardimcilari/9/mehmet-yardimsever.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Mehmet Yardımsever</h5>
                          <strong class="dep">Başkan Yardımcısı</strong>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div>
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/baskanYardimcilari/9/aysegul-dalgic.png"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Ayşegül Dalgıç</h5>
                          <strong class="dep">Başkan Yardımcısı</strong>
                          <ul class="team-social">
                            <li><em>Sosyal: :</em></li>
                            <li>
                  ...
                  <div class="row listele">
                    <a class="sayfanumarasi" href="baskanyardimcilari/1.html"
                      >1</a
                    >
                  </div>
                </div>
