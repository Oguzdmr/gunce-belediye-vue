              ...
              >
                <div class="row">
                  <div class="col-md-12 contact-form m80">
                    <h3 class="stitle text-center">Bir Fikrim Var!</h3>
                    <form>
                      <ul>
                        <li class="col-md-6">
                        ...
                        <li class="col-md-6">
                          <input type="text" placeholder="Fikrinizin konusu" />
                        </li>
                        <li class="col-md-12">
                          <textarea placeholder="Fikrinizi yazınız."></textarea>
                        </li>
                        <li class="col-md-12">
                          <input type="submit" value="Fikrini İlet" />
                        </li>
                      </ul>
                    </form>
                  </div>
