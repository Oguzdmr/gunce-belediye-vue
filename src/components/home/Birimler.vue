              ...
              >
                <div class="team-grid official-members">
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      <a href="/birimler/ornek-birim-24"
                        ...
                        >
                          ...
                          <div class="team-txt">
                            <h5>Örnek Birim</h5>
                            <strong class="dep">Ali KARALI</strong>
                            <ul class="team-social">
                              <li><em>Örnek Birim Müdürü:</em></li>
                            </ul>
                          </div>
                        </div></a
                      >
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      <a href="/birimler/ornek-birim-26"
                        ...
                        >
                          ...
                          <div class="team-txt">
                            <h5>Örnek Birim</h5>
                            <strong class="dep">Birim Yetkili 2</strong>
                            <ul class="team-social">
                              <li><em>Örnek Birim Müdürü:</em></li>
                            </ul>
                          </div>
                  ...
                  <div class="row listele">
                    <router-link tag="a" to="/birimler/1" class="sayfanumarasi">1</router-link>
