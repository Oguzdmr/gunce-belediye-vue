              ...
              >
                <div class="team-grid official-members">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/encumenler/9/ali-enli.jpg"
                        ...
                        <div class="team-txt">
                          <h5>Ali Enli</h5>
                          <strong class="dep">Encümen</strong>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/encumenler/9/davut-yener.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/encumenler/9/beyza-sevengul.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Beyza Sevengül</h5>
                          <strong class="dep">Encümen</strong>
                          <ul class="team-social">
                            <li><em>Sosyal: :</em></li>
                            <li>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/encumenler/9/kemal-kara.png"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                  ...
                  <div class="row listele">
                    <a class="sayfanumarasi" href="encumenler/1.html">1</a>
                  </div>
                </div>
              </div>
              <Hizlimenu />
...
export default {
  ...
  mounted() {
    $(".acilirkutu").mouseover(function() {
      $(".team-txt", this).attr(
        "style",
        "transition:all 0.6s;margin-top:-300px;"
      );
      $(".hed-div", this).attr(
        "style",
        "transition:all 0.6s;margin-top:-300px;"
    ...
    $(".kutu").mouseover(function() {
      $(".team-txt", this).attr(
        "style",
        "transition:all 0.6s;margin-top:-200px;opacity:0.6; padding-top:90px;"
      );
      $(".team-txt h5", this).attr(
        "style",
        "transition:all 0.6s;color:#ff7200;"
      );
    });
    $(".kutu").mouseleave(function() {
      $(".team-txt", this).attr(
        "style",
        "transition:all 0.6s;margin-top:-50px;opacity:1; background:#ff720087;"
      );
