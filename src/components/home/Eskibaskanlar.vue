              ...
              >
                <div class="team-grid official-members">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/eskiBaskanlar/9/hamit-gumustop.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Hamit Gümüştop</h5>
                          <strong class="dep"
                            >2014-2019 Döneminde başkanlık görevini
                            yürütmüştür.</strong
                          >
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/eskiBaskanlar/9/adil-yurtseven.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Adil Yurtseven</h5>
                          <strong class="dep"
                            >2009-2014 Döneminde başkanlık görevini
                            yürütmüştür.</strong
                          >
                          <ul class="team-social">
                            <li><em>Sosyal: :</em></li>
                  ...
                  <div class="row listele">
                    <a class="sayfanumarasi" href="eskibaskanlar/1.html">1</a>
                  </div>
                </div>
              </div>
              <Hizlimenu/>
