              ...
              >
                <div class="team-grid official-members">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/muhtarlar/9/guncelleme/13.jpg"
                        ...
                        <div class="team-txt">
                          <h5>Durak Ergün</h5>
                          <strong class="dep"
                            >Gündoğdu Mahallesi Mahallesi Muhtarı</strong
                          >
                          <p>Adres: 0 555 555 55 55</p>
                          <p>Telefon: Gündoğdu mahallesi no:12</p>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/muhtarlar/9/guncelleme/14.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Veli Yanar</h5>
                          <strong class="dep"
                            >Aydoğan Mahallesi Mahallesi Muhtarı</strong
                          >
                          <p>Adres: 0 555 555 55 55</p>
                          <p>Telefon: Aydoğan mahallesi no:7</p>
                          <ul class="team-social">
                            <li><em>Sosyal: :</em></li>
                            <li>
                              <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/muhtarlar/9/fatma-kaya.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Fatma Kaya</h5>
                          <strong class="dep"
                            >Günbatan Mahallesi Mahallesi Muhtarı</strong
                          >
                          <p>Adres: Günbatan mahallesi No:5</p>
                    ...
                    <div class="col-md-4 col-sm-6 acilirkutu">
                      ...
                      >
                        <div class="team-thumb">
                          <img
                            src="../../../public/admin.togdem.com/AdminPanel_Assets/img/muhtarlar/9/kerim-ozen.jpg"
                            style="height:300px; object-fit:contain;"
                            alt=""
                          />
                        </div>
                        <div class="team-txt">
                          <h5>Kerim Özen</h5>
                          <strong class="dep"
                            >Çaydan Mahallesi Mahallesi Muhtarı</strong
                          >
                          <p>Adres: Çaydan mahallesi no:17</p>
                          <p>Telefon: 0 555 555 55 55</p>
                          <ul class="team-social">
                            <li><em>Sosyal: :</em></li>
                            <li>
                  ...
                  <div class="row listele">
                    <a class="sayfanumarasi" href="Muhtarlar/1.html">1</a>
                  </div>
                </div>
              </div>
              <Hizlimenu/>
