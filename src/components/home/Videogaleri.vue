                ...
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <div class="gallery-thumb">
                      <a
                        href="http://admin.togdem.com/AdminPanel_Assets/video/videoGaleri/9//ornek-video-1/ornek-video-1.mp4"
                        data-rel="prettyPhoto[gallery]"
                        ><i class="fas fa-play"></i
                      ></a>
                      <img
                        src="../../../public/admin.togdem.com/AdminPanel_Assets/video/videoGaleri/9/ornek-video-1/ornek-video-1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
