                ...
                <div class="sidebar">
                  ...
                  <div class="widget">
                    ...
                    <div class="categories inner">
                      <ul>
                        <li>
                          <a href="../mecliskararlari.html">Meclis Kararları</a>
                        </li>
                        <li>
                          <a href="../komisyonkararlari.html"
                            >Komisyon Kararları</a
                          >
                        </li>
                        <li>
                          <a href="../faaliyetraporlari.html"
                            >Faaliyet Raporları</a
                          >
                        </li>
                        <li><a href="../baskanasor.html">Başkana Sor</a></li>
                        <li>
                          <a href="../bifikrimvar.html">Bir Fikrim Var</a>
                        </li>
